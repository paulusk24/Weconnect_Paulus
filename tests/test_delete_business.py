...
class Delete_business(BaseTestCase):
    ...
    def test_delete_at_delete_business_endpoint(self):
        ...
        response = self.client.delete('/api/v1/businesses/<businessId>')
